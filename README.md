...
This package is the Protobuf infrastructure for [`tanebi`](https://github.com/SaltifyDev/tanebi), which provides efficient serialization and deserialization of protocol packets.
